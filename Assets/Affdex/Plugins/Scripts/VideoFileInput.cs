...
namespace Affdex
{
    ...
    public class VideoFileInput : MonoBehaviour, IDetectorInput
    {
        ...
        {
            movie.Play();
            t2d = new Texture2D(movie.texture.width, movie.texture.height, TextureFormat.RGB24, false);
        ...
        private void ProcessFrame()
        {
            ...
            if (this.movie != null)
            {
                ...
                RenderTexture rt = RenderTexture.GetTemporary(movie.texture.width, movie.texture.height, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default, 1);
